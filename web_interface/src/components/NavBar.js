...
import { Button, Alignment, Navbar, NavbarDivider, NavbarGroup, NavbarHeading } from '@blueprintjs/core';
...
const NavBar = () => (
	<Navbar>
		...
		<NavbarGroup align={Alignment.RIGHT}>
			...
			<NavbarDivider />
			<a target="_blank" href="https://github.com/SevcanDogramaci/AnGenoV" rel="noreferrer">
